...
interface LoadingSkeletonProps {
  variant?: "card" | "stats" | "list" | "text" | "document" | "flashcard";
  count?: number;
}
...
export function DocumentCardSkeleton({ count = 1 }: { count?: number }) {
  return <LoadingSkeleton variant="document" count={count} />;
}

export function FlashcardSkeleton() {
  return <LoadingSkeleton variant="flashcard" />;
}
